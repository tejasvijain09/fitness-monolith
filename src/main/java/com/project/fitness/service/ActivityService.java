...
public class ActivityService {
    ...
    public  List<ActivityResponse> getUserActivities(String userId) {
        ...
        return activityList.stream() // “List vich har Activity nu ActivityResponse vich convert karo te navi list bana ke return karo”
                .map(this::mapToResponse) // Har Activity te mapToResponse() method lagao
